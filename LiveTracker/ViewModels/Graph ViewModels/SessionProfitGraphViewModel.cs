...
{
    public class SessionProfitGraphViewModel : NotificationObject
    {
        public SessionProfitGraphViewModel(ObservableCollection<SessionModel> sessions)
        {
            // font color
        ...
        private void SaveImage(object parameter)
        {
            ...
            {
                Owner = Application.Current.Windows.OfType<SessionProfitGraphView>().FirstOrDefault(),
